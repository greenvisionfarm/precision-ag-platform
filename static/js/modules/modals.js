      ...
      Swal.fire({
        ...
        didOpen: () => {
          ...
          $("#modal-export-kmz").on("click", () => {
            Swal.close();
            this.downloadKmzWithSettings(id);
          });
...
export function openFieldModal(id) { return modalManager.openFieldModal(id); }
export function downloadKmzWithSettings(fieldId) { return modalManager.downloadKmzWithSettings(fieldId); }
