...
3.  **Экспорт в DJI Pilot (KMZ):** Генератор полетных заданий для Mavic 3M (XML template.kml). Поддержка кастомизации высоты (20-120м) и перекрытий (H/W overlap).
4.  **Обработка данных дронов (Roadmap):**
